...
class GeneInfo12(models.Model):
    ...
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo13(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo14(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo15(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo16(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo17(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo18(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo19(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo20(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo21(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo22(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo23(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo24(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo25(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo26(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo27(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
    createtime=models.DateTimeField()
class GeneInfo28(models.Model):
    genename=models.CharField(max_length=500)
    genedescription=models.CharField()
    genesectiongroup=models.CharField()
    geneprobetype=models.CharField(max_length=500)
